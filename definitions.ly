...
mfpE = #(make-dynamic-script (markup #:line (#:normal-text #:italic #:large #:bold "mfp")))
...
rfz = #(make-dynamic-script (markup #:line (#:whiteout #:normal-text #:large #:bold "rfz")))
rfzE = #(make-dynamic-script (markup #:line (#:whiteout #:normal-text #:italic #:large #:bold "rfz")))
pocoF = #(make-dynamic-script (markup #:line (#:whiteout #:normal-text #:small "poco" #:normal-text #:large #:bold "f")))
pocoFE = #(make-dynamic-script (markup #:line (#:whiteout #:normal-text #:small #:italic "poco" #:normal-text #:large #:bold #:italic "f")))
...
\include "notes/n_01_fl1.ly"
\include "notes/n_02_fl2.ly"
\include "notes/n_03_ob1.ly"
\include "notes/n_04_ob2.ly"
\include "notes/n_05_cor1.ly"
\include "notes/n_06_cor2.ly"
\include "notes/n_07_vl1.ly"
\include "notes/n_08_vl2.ly"
\include "notes/n_09_vla.ly"
\include "notes/n_10_S.ly"
\include "notes/n_11_A.ly"
\include "notes/n_12_T.ly"
\include "notes/n_13_B.ly"
\include "notes/n_14_org.ly"