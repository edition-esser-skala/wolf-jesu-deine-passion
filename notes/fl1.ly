...
LieblichFlautoI = {
  \relative c' {
    ...
    h'8 h4 \appoggiatura h32 \once \slurDashed a16(^\critnote g) \once \slurDashed fis8( d'16.) cis32 cis8( h16.) a32
    a8( gis16.) fis32 fis8( e16.) d32 cis8 a r4
    r r8 \pa e'32( d cis h) a8 \once \slurDashed e'16( a) \pd \appoggiatura e8 d4\trill
    cis8 cis' r4 r r8 \pa e,32( d cis h) \pd %15
    a8 \once \slurDashed e'16( a,) \pa h4\trill a \pd r \bar "S-|"
    ...
    gis8 h r4 r r8 \pa h32( a gis fis)
    e16( gis) gis( h) \pd \appoggiatura h8 a4 gis8 e'\p r4
    r r8 \pa h32( a gis fis) \pd e8.\fE h16 fis'4\trill
    \pao e r r h8.(\pE cis32 d!)
    ...
    e8( dis16.)\pE cis32 cis8( h16.) a32 a8\trill gis r \once \slurDashed cis16(\mfE a)
    ...
    cis8 \once \partCombineChords e' r4 r r8 \pa e,32( d cis h)
    a8 a' h,^\critnote gis' \pd a4 r
    ...
    a8 \once \slurDashed e'16( a,) h4\trill \pao a r \bar "||"
    ...
    a8 \once \slurDashed e'16( a,) h4\trill \pao a r \bar "S-S" %117 finis
  }
}
