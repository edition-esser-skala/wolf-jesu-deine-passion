...
LieblichViolinoI = {
	\relative c' {
		...
		cis'8.\fE( d32 e) cis8 r cis8.( d32 e) cis8 r
...
MeineSeeleViolinoI = {
	\relative c' {
		...
		a'8\fE h cis d e2~
		e8.[ fis16 \appoggiatura e d8. e16] \appoggiatura d32 cis16 cis' h a gis fis e d
		cis8 a cis d e2~
		e8.[ fis16 \appoggiatura e d8. e16] \appoggiatura d32 cis16 cis' h a gis fis e d
		cis8 r fis4 \appoggiatura e8 dis4 r8 cis\p %5
		gis4. a8 e4 gis8 a
		e4 gis8 a e4 r
		e r e r8 e
		a gis a dis, e4 e'\f
		cis r8 cis fis fis16 fis fis8 e %10
		dis h cis dis e dis e a
		\appoggiatura a16 gis8 fis16( e) fis4\trill e8 gis16( a) h4
		r8 cis16( a) r8 fis16( a) gis8 gis,16(\p a) h4
		r8 cis16( a) r8 fis16( a) a4(\pp gis8) r
		e\f fis gis a h2~ %15
		h8.[ cis16 \appoggiatura h a8. h16] \appoggiatura a32 gis16 gis' fis e dis cis h a
		gis8 e gis a h2~
		h8.[ cis16 \appoggiatura h a8. h16] \appoggiatura a32 gis16 gis' fis e dis cis h a
		gis8 r cis4 \appoggiatura h8 a4 r8 d\p
		a4. h8 fis4 a8 h %20
		fis4 a8 fis h4 d\f
		\appoggiatura cis8 h4 r8 h e e16 e e8 d
		cis a cis d e d16 cis fis8 e16 d
		g8 a g fis e4 r8 fis,\p
		cis4. d8 a4 cis8 d %25
		a4 cis8 d a4 r
		r8 cis'\f e g fis fis16 e d8 cis
		cis h d cis16 h cis8 d e fis
		cis4 h\trill a r8 g'
		fis fis16 e d8 cis cis h d cis16 h %30
		cis8 d e fis cis4 h\trill
...
DuSchoenerViolinoI = {
	\relative c' {
		...
		a2 gis2~
		gis1
		fis8 \slurDashed a16(\f fis) fis( dis) dis( cis) \slurSolid his4 r
		dis'1\p %5
		cis4 r16 r32 cis\f cis16. cis32 gis'4 r
		r2 r16 r32 dis dis16. dis32 dis16. dis32 dis16. dis32
		fis4 r16 r32 fis fis16. fis32 fis16. fis32 fis16. fis32 a4
		r2 r16 r32 f f16. f32 f4
		r16 r32 es es16. es32 es4 r16 f\f \tuplet 3/2 8 { f([ c) c]-!\p c(\f a) a-!\p a([\f f) f]\p-! } %10
		ges'4\f r r r8 r16 f,\f
		...
		e!4 r r2
		R1*13 %30
		r8 \mvTr b'-!\pE-\markup { \remark "staccato con sordini" } d-! es-! r as,-! f'-! es-!
		r es-! as,-! g-! r2
		r8 b-! d-! es-! r as,-! f'-! es-!
		r es-! as,-! g-! r2
		...
		es r d r %40
		r8 r16 d d8 d r r16 d d8 d
		r r16 e! e8 e r16 r32 e e16. e32 e16. e32 e16. e32
		e4 r r2
		a4 r f r
		r e-\markup { \remark "col’arco, senza sordini" } \key a \major \tempoMeinJesus a,8(-. a'-.) a(-. a-.) %45
		a(-. a-.) gis(-. gis-.) fis(-. fis-.) e(-. e-.)
		a-\simileE a h h cis cis h h
		gis gis cis cis cis cis cis cis
		h h a a d d cis cis
		h h a a gis gis a a %50
		h h cis cis h h a a
		fis fis fis fis a a a a
		a a cis cis d d cis cis
		h h a a d d cis cis
		h h a a a a gis gis %55
		a a a a \tempoSeydGetrost a4 r8 a
		...
		R1*13 %83
		r2 \tempoMeinJesusB r8 a'(-.\p a-. a-.)
		a(-. a-.) gis(-. gis-.) fis(-. fis-.) e(-. e-.) %85
		a-\simileE a h h cis cis h h
		gis gis cis cis cis cis cis cis
		h h a a d d cis cis
		h h a a gis gis a a
		h h cis cis h h a a %90
		fis fis fis fis a a a a
		a a cis cis d d cis cis
		h h a a d d cis cis
		h h a a a a gis gis
		a a a a \tempoSeydGetrostB a4 r8 a %95
		gis4 r16 e\f gis h gis e gis h gis e gis h
		a8 e[\p gis e] a e gis e
		a e r e h' a h h,
		...
		r r8 a gis4 r16 e\f gis h %125
		gis e gis h gis e gis h a8 e[\p gis e]
		a e gis e a e r e
		h' a h h, e4 \tempoOWehe a
		h cis h a
		a gis a\fermata r %130
		r e' d cis
		h a d h\trill
		a\fermata \tempoSeydGetrostD r8 a gis4 r16 e\f gis e
		...
		h8.[ h16 h8. h16] e,2
		r4 e d d'
		d cis d r\fermata \bar "|." %154 finis
	}
}
...
VersoehnerViolinoI = {
	\relative c' {
		...
		r a,(\f c! e) a2\fp
		r8 h,(\f d g) h2\p
		r8 \once \slurDashed cis,(\f e a) cis4.\p e,8 %10
		\appoggiatura e-\critnote d4 g~\mf g8 fis16\p e d8 cis
		\appoggiatura cis? d4 h'~\f h8 a16 g fis8 e\trillE
		...
		r c e4~ e8 d\p( d, c')
		r4 r8 d d( c) c( h)
		h-\critnote a d2\fE cis4\p %20
		\appoggiatura cis?8 d4 e4~\f e8 d16\p c h8 a
		r g(\f h d) r f( h d)
		r e,(\p g c) r d,( g h)
		r d,( d, c') r h(\f g' e)
		...
		e8 d16\p c h8 a g8 h(\f e-\critnote g) %30
		r d,( g h) d-! fis( a c)
